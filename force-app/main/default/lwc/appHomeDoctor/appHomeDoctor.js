...
import DOCTORS_IMAGE from '@salesforce/resourceUrl/APP_ImageHomeDoctor';
import agendaIcon from '@salesforce/resourceUrl/APP_AgendaIcon';
import mensagemIcon from '@salesforce/resourceUrl/APP_MensagensIcon';

const FIELDS = ['User.Name'];

export default class AppHomeDoctor extends LightningElement {
    userName;
    quickActions = [];
    doctorsImage = DOCTORS_IMAGE;
    agenda = agendaIcon;
    mensagemIcon = mensagemIcon;
